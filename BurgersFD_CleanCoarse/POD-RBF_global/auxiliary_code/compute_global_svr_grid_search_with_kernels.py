...
def main():
    ...
    C_values = np.logspace(np.log10(10), np.log10(100), 1)        # [1, 10]
    eps_values = np.logspace(np.log10(0.001), np.log10(0.01), 2) # [0.001, 0.00316, 0.01, 0.0316, 0.1]   
    gamma_values = np.logspace(np.log10(1), np.log10(1000), 20) # [1, ..., 1000]
