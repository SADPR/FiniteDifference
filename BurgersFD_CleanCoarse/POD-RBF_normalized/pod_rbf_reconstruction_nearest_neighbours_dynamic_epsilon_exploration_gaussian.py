...
def find_best_epsilon_per_snapshot(hdm_snap, U_p, U_s, q_p_train, q_s_train, kdtree, r, constant=0.1, neighbors=20):
    ...
    for i in range(num_snapshots):
        ...
        for j in range(q_p.shape[1]):
            ...
            epsilon_inv = 0.00001#calculate_epsilon_inverse_nearest_neighbor(kdtree, q_p_train, q_p_sample, neighbors)
            epsilon_domain = 0.00001#calculate_epsilon_proportional_to_domain_size(kdtree, q_p_train, q_p_sample, neighbors, constant)
