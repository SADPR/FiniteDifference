...
def generate_comparison_plot(
    ...
    all_models = ["HPROM", "HPROM-ANN", "HPROM-GP", "HPROM-RBF"]
...
if __name__ == "__main__":
    ...
    selected_indices = [1]  # Modify this list to select different combinations

    # Generate plot
    out_png = f"single_layer_mu1_{mu1:.2f}_mu2_{mu2:.3f}.png"
