...
def main():
    ...
    space = [
        Real(np.log(1e-2), np.log(10), name='log_alpha1'),
        Real(np.log(1e-2), np.log(10), name='log_alpha2'),
        Real(np.log(1e-2), np.log(10), name='log_alpha3'),
        Real(np.log(1e-2), np.log(10), name='log_alpha4'),
        Real(np.log(1e-2), np.log(10), name='log_alpha5'),
        Real(np.log(1e-2), np.log(10), name='log_alpha6'),
        Real(np.log(1e-2), np.log(10), name='log_alpha7'),
        Real(np.log(1e-2), np.log(10), name='log_alpha8'),
        Real(np.log(1e-2), np.log(10), name='log_alpha9'),
        Real(np.log(1e-2), np.log(10), name='log_alpha10'),
    ...
    def objective(log_alpha1, log_alpha2, log_alpha3, log_alpha4, log_alpha5, log_alpha6, log_alpha7, log_alpha8, log_alpha9, log_alpha10, kernel_name, log_lambda_val):
        ...
        dists_train_aniso = anisotropic_distance_matrix_cross(X_train, X_train, alpha)
        ...
        dists_val_aniso = anisotropic_distance_matrix_cross(X_val, X_train, alpha)
        ...
        rpe = (np.linalg.norm(y_val - y_val_pred, 'fro') /
