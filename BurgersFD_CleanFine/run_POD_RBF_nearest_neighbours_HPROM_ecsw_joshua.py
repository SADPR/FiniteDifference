...
def main(mu1=4.75, mu2=0.02, compute_ecsw=False, save_npy=False, save_plot=False):
    ...
    labels_anim = ['HDM', 'POD-RBF HPROM (Nearest Neighbour)']
    ...
    if save_gif:
        ...
        anim_filename = f'pod_rbf_hprom_nearest_{mu_rom[0]:.2f}_{mu_rom[1]:.3f}.gif'
...
if __name__ == "__main__":
    main(mu1=5.5, mu2=0.03, compute_ecsw=False, save_npy=True, save_plot=True)
