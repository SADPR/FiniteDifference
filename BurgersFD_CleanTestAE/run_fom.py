...
def main(mu1=4.56, mu2=0.02, save_snaps=True):
    """
...
if __name__ == "__main__":
    main(mu1=4.25, mu2=0.015)
    #main(mu1=4.25, mu2=0.0225)
    #main(mu1=4.25, mu2=0.03)
    #main(mu1=4.875, mu2=0.015)
    #main(mu1=4.875, mu2=0.0225)
    #main(mu1=4.875, mu2=0.03)
    #main(mu1=5.5, mu2=0.015)
    #main(mu1=5.5, mu2=0.0225)
    #main(mu1=5.5, mu2=0.03)
